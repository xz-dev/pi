...
required_paths=(
    ...
    "scripts/build-musl-clipboard.sh"
    "scripts/lib/musl-provenance.mjs"
    "scripts/verify-musl-provenance.mjs"
    "scripts/prepare-musl-smoke.mjs"
    "scripts/test-native-clipboard.mjs"
