 ...
 *   scripts/lib/github-release.mjs on the ci branch.
 *
...
const common = {
	darwin: { wrapper: "pi", executable: "pi-native", archive: "zip" },
	linux: { wrapper: "pi", executable: "pi-native", archive: "zip" },
	windows: { wrapper: "pi.exe", executable: "pi-native.exe", archive: "zip" },
};
