...
const { BUN_TARGETS, binaryArchiveName, bunTarget } = await import(join(LIB_DIR, "bun-targets.mjs"));
...
if (contract.schemaVersion !== 4) fail(`Expected generated contract schemaVersion 4, got ${contract.schemaVersion}`);
...
if (process.exitCode === undefined) {
	console.log(`OK: generated runtime contract matches CI descriptor (${expected.length} targets, schema v4).`);
}
