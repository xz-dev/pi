...
function fixture() {
	...
	for (const target of BUN_TARGETS) {
		const stage = join(root, `stage-${target.id}`); mkdirSync(stage, { recursive: true });
	...
	const manifest = { schemaVersion: 5, commit: "b".repeat(40), bundles, attestation: { subjectsFile: "attestation-subjects.jsonl" } };
