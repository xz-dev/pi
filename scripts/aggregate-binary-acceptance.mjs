...
for (const id of BUN_TARGET_IDS) {
	...
	const expectedTui = descriptor.os === "windows" ? { harness: "Win32 ConPTY API", input: "startup-benchmark", exitSent: false } : { harness: "Bun.Terminal PTY", input: "ctrl-c,ctrl-d", exitSent: true };
