...
describe("Esc abort stuck extension integration", () => {
	...
	// Quarantined downstream: tmux-driven test waits 15s for the stuck marker,
	// which flakes under the isolated-HOME release test environment's load.
	it.skip("clears Working after Esc when a context extension hook never settles", () => {
