		...
		switch (command.type) {
			...
			case "get_state": {
				const state: RpcSessionState = {
					...
					remoteCompactionEnabled: session.remoteCompactionEnabled,
			...
			case "set_remote_compaction": {
				session.setRemoteCompactionEnabled(command.enabled);
				return success(id, "set_remote_compaction");
			}
